...
GO
CREATE VIEW [dbo].[vwSalesTurnoverDetail]
AS
...
WHERE     (fc.tblInvoiceDetails.lngCompanyID <> 716) AND (fc.tblInvoiceDetails.lngCompanyID <> 532) AND (fc.tblInvoiceDetails.lngCompanyID <> 226)
