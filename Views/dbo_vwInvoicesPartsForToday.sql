...
GO
CREATE VIEW [dbo].[vwInvoicesPartsForToday]
AS
SELECT     fc.tblInvoiceParts.*
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[29] 4[4] 2[40] 3) )"
      End
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwInvoicesPartsForToday'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'dbo', 'VIEW', N'vwInvoicesPartsForToday'
GO