...
GO
CREATE VIEW [dbo].[vwInvoicesPartNotesForToday]
AS
SELECT     fc.tblInvoicePartNotes.*
FROM         fc.tblInvoiceDetails INNER JOIN
                      ...
                      fc.tblInvoicePartNotes ON fc.tblInvoiceParts.lngPartNoteID = fc.tblInvoicePartNotes.lngPartNoteID
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "tblInvoiceParts (fc)"
            ...
            TopColumn = 18
         End
         Begin Table = "tblInvoicePartNotes (fc)"
            Begin Extent = 
               Top = 35
               Left = 594
               Bottom = 120
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwInvoicesPartNotesForToday'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'dbo', 'VIEW', N'vwInvoicesPartNotesForToday'
GO