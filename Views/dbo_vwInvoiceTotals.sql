...
GO
CREATE VIEW [dbo].[vwInvoiceTotals]
AS
SELECT DISTINCT 
                      fc.vwSearchInvoicePartsDetails.lngInvoiceID, SUM(fc.vwSearchInvoicePartsDetails.TotalPrice) AS TotalPrice, 
...
GROUP BY fc.vwSearchInvoicePartsDetails.lngInvoiceID
GO
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwInvoiceTotals'
GO

EXEC sys.sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'dbo', 'VIEW', N'vwInvoiceTotals'
GO